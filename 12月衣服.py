...
print ("26号             风衣             253.6            500                 43 ")
print ("27号             皮草             135.9            855                 57 ")
print ("28号            羽绒服            253.6            500                 10 ")
print ("29号             T恤             65.8             632                63 ")
print ("30号             风衣             96.8            335                78 ")
print ("-------------------------------------------------------------------------")
print ("12月份销售总额为",(253.6*(10+69+140+10+10)+86.3*(60+72+35+90+60+60+140)+
                    96.8*(43+25+43+60+43+78)+135.9*(63+24+63+57)+65.8*(63+45+129+63+58+48+63)
                    +49.3*120))
print ("羽绒服占总销售额的比为",(253.6*(10+69+140+10+10)/198400.6000000003)*100,"%")
print ("牛仔裤占总销售额的比为",(86.3*(60+72+35+90+60+60+140)/198400.6000000003)*100,"%")
print ("风衣占总销售额的比为",(96.8*(43+25+43+60+43+78)/198400.6000000003)*100,"%")
print ("皮草占总销售额的比为",(135.9*(63+24+63+57)/198400.6000000003)*100,"%")
print ("T恤占总销售额的比为",(65.8*(63+45+129+63+58+48+63)/198400.6000000003)*100,"%")
print ("衬衫占总销售额的比为",(49.3*120/198400.6000000003)*100,"%")